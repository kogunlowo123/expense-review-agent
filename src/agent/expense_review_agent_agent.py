"""Expense Review Agent - Main Agent Implementation."""
...
class ExpenseReviewAgentAgent:
    ...
    def __init__(self):
        ...
        self.expense_enabled = True
        self.review_enabled = True
        self.compliance_enabled = True
        self.reporting_enabled = True
        self._tool_dispatch = {
            "validate_expense": self.tools.validate_expense,
            "flag_outliers": self.tools.flag_outliers,
            "verify_receipt": self.tools.verify_receipt,
            "calculate_reimbursement": self.tools.calculate_reimbursement,
        ...
        logger.info(
            ...
            features=['expense', 'review', 'compliance', 'reporting'],
        )
    ...
    async def _maybe_execute_tools(self, message: str, context: str) -> list[dict]:
        ...
        tool_keywords = {
            ...
            "calculate_reimbursement": ['calculate', 'reimbursement'],
