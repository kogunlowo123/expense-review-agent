"""Expense Review Agent - FastAPI Application."""
...
app = FastAPI(
    ...
    description="Expense review agent that validates expense reports against company policy, flags outliers, checks receipt authenticity, calculates reimbursements, and generates compliance reports.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
